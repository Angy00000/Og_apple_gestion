...
const FUNCTIONS = {
  ...
  api_update_customer: ['p_id', 'p_payload', 'p_user_id'],
  api_delete_customer: ['p_id', 'p_user_id'],
  api_get_customer_detail: ['p_customer_id'],
  api_create_product: ['p_payload'],
  api_update_product: ['p_id', 'p_payload', 'p_user_id'],
  api_delete_product: ['p_id', 'p_user_id'],
  api_update_stock_unit: ['p_id', 'p_payload', 'p_user_id'],
  api_delete_stock_unit: ['p_id', 'p_user_id'],
  api_add_stock_direct: ['p_payload', 'p_user_id'],
  api_create_occasion_purchase: ['p_payload', 'p_user_id'],
  api_log_refused_tradein: ['p_payload', 'p_user_id'],
  api_list_audit: ['p_limit'],
  api_list_invoices: [],
